...
- Documentation is licensed under [Creative Commons Attribution-ShareAlike 4.0 International](./LICENSE) (CC BY-SA 4.0).
- Code snippets in `CODE_SNIPPETS.md` are licensed under the [MIT License](./LICENSE-CODE-MIT).
...
- Security guidance is documented in [SECURITY.md](./SECURITY.md).
